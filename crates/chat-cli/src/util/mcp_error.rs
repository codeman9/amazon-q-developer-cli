...
impl Clone for McpError {
    fn clone(&self) -> Self {
        match self {
            ...
            Self::ServerUnavailable { server_name } => Self::ServerUnavailable {
                server_name: server_name.clone(),
            },
            ...
            Self::MissingSchemaField { field_name } => Self::MissingSchemaField {
            ...
            // General errors
            Self::OperationCancelled { operation } => Self::OperationCancelled {
            ...
            Self::McpClient(e) => Self::Internal {
                message: format!("MCP client error: {}", e),
            },
            Self::Transport(e) => Self::Internal {
...
impl McpError {
    ...
    pub fn is_retryable(&self) -> bool {
        match self {
            ...
            Self::McpClient(_) | Self::Transport(_) => false,
        }
    }
...
mod tests {
    ...
    fn test_error_retryability() {
        assert!(
            McpError::ServerConnectionFailed {
